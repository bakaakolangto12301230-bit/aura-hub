...
export const featuredProduct: Product = { id: "weekender", name: "Form Weekender", category: "Carry", price: 248, description: "Soft-grain leather, considered down to the last pocket.", image: shopImage, accent: "Graphite" };
...
export const featuredEvent: Offering = { id: "golden-hour", name: "Golden Hour Gathering", category: "Celebration", price: 4200, priceLabel: "From $4,200", description: "A warm, effortless celebration shaped around your people.", details: ["Up to 60 guests", "Seasonal dining menu", "Florals and ambient lighting", "Event host and coordination"], image: eventsImage };
...
export const featuredAutoService: Offering = { id: "signature-detail", name: "Signature Detail", category: "Complete care", price: 289, priceLabel: "$289", description: "A meticulous inside-and-out reset for your daily drive.", details: ["Hand wash and decontamination", "Interior deep clean", "One-step paint enhancement", "4–5 hours"], image: autoImage };
